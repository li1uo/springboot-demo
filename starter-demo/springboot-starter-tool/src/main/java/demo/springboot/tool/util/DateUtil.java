...
public class DateUtil {
	...
	private static SimpleDateFormat sdf = new SimpleDateFormat(PATTERN_DATETIME);
	private static SimpleDateFormat simpleDateFormat = new SimpleDateFormat(PATTERN_DATE);
	/**
	 * 老 date 格式化
	 */
